<template>
  <div class="container mx-auto px-4 py-6">
    <div class="flex items-center justify-between gap-3 mb-6">
      <div>
        <h2 class="text-2xl font-semibold">Kuis Saya</h2>
        <p class="text-sm text-gray-500">Kerjakan kuis dari gurumu dan ukur pemahamanmu.</p>
      </div>
    ...
    <div v-else-if="filtered.length === 0" class="text-center py-16 bg-white dark:bg-gray-900 border border-dashed border-gray-300 dark:border-gray-600 rounded-xl">
      <Icon name="material-symbols:quiz" class="w-14 h-14 text-gray-300 mx-auto mb-3" />
      <p class="text-gray-500">Belum ada kuis yang tersedia untuk Anda.</p>
    </div>
