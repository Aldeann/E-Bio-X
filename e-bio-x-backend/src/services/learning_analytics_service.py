...
ALLOWED_EVENT_TYPES = {
    ...
    'FORUM_COMPLETED',
    # AI quiz explanation events (Prompt 12)
    'QUIZ_EXPLANATION_VIEWED',
    'AI_EXPLANATION_GENERATED',
    'AI_EXPLANATION_APPROVED',
    'AI_EXPLANATION_REGENERATED',
    'AI_EXPLANATION_VALIDATION_FAILED',
    'RECOMMENDED_MATERIAL_CLICKED',
    'AI_EXPLANATION_VIEWED_FEEDBACK',
}
